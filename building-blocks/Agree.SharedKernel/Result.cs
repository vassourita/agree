...
public abstract class Result<TData> : Result, IResult
{
    ...
    /// <exception cref="InvalidOperationException">Thrown when trying to access the data from a failed result.</exception>
    public TData Data
    {
...
public abstract class Result<TData, TError> : Result, IResult
{
    ...
    /// </summary>
    /// <value>A value of type <c>TData</c> if the operation succeeded.</value>
    /// <exception cref="System.InvalidOperationException">Thrown when trying to access the data from a failed result.</exception>
    public TData Data
    {
        get => Succeeded ? _data : throw new InvalidOperationException($"You can't access .{nameof(Data)} when .{nameof(Succeeded)} is false");
        private set => _data = value;
    ...
    /// <exception cref="System.InvalidOperationException">Thrown when trying to access the data from a succeeded result.</exception>
    public TError Error
    {
